...
class AdminDashboard extends React.Component {
  ...
  async componentDidMount() {
    ...
    await fetch(process.env.REACT_APP_API_URL + "/api/games/currentGames")
      .then((res) => res.json())
      .then((results) => {
      ...
      .catch((err) =>
        console.log("Big error with api/games/currentGames", err)
      );
  }
  ...
  handleStart() {
    ...
    // console.log(game_id);
    if (game_id) {
      fetch(process.env.REACT_APP_API_URL + "/api/games/gameStartTransfer", {
        method: "POST",
  ...
  handleEnd() {
    ...
    if (game_id) {
      fetch(process.env.REACT_APP_API_URL + "/api/games/gameEndTransfer", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          game_id: game_id,
                  ...
                  <Card style={{ width: "30rem" }}>
                    <Card.Body>
                      ...
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item onClick={this.handleRemoveUpdate}>
                            None
                          </Dropdown.Item>
                          <Dropdown.Item onClick={this.handleDisplayUpdate}>
                            Current Game Title
                          </Dropdown.Item>
                          <Dropdown.Item onClick={this.handleDisplayUpdate}>
                            Next Game Title
                ...
                <div class="col-4">
                  <Card style={{ width: "40rem" }}>
                    <Card.Body>
                      ...
                      <Button
                        variant="primary"
                        onClick={this.handleDisplayAccounts}
                      >
                        {manageButton}
                      </Button>
                  ...
                  <Card style={{ width: "40rem" }}>
                    <Card.Body>
                      <Card.Title>
                        View Registered Players for a Game
                      </Card.Title>
                      <Dropdown>
                        <Dropdown.Toggle variant="primary" id="dropdown-basic">
                          Select Game
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item onClick={this.handleRemoveRegPlayers}>
                            None
                          </Dropdown.Item>
                          <Dropdown.Item onClick={this.handleDisplayRegPlayers}>
                            Current Game Title
                          </Dropdown.Item>
                          <Dropdown.Item onClick={this.handleDisplayRegPlayers}>
                            Next Game Title
              ...
              <div className="row">
                ...
                <div className="">
                  ...
                  <div style={{ display: "flex", margin: "10px" }}>
                    ...
                    <Button variant="danger" onClick={this.handleEnd}>
                      End
                    </Button>
                  </div>
                </div>
