    ...
    if (this.state.result === "Aim Camera at QR Code") {
      return (
        <React.Fragment>
          <div>
            <Button
              onClick={() => this.setState({ showComponent: !showComponent })}
            >
              Click to use QR Code Scanner
            </Button>
      ...
      return (
        <div>
          <Button
            onClick={() => this.setState({ result: "Aim Camera at QR Code" })}
          >
            Click to Scan Another Code
          </Button>
