...
class PropertyLog extends Component {
  ...
  handleSubmit(e) {
    this.setState({ prevResult: this.state.username });

    e.preventDefault();

    fetch(process.env.REACT_APP_API_URL + "/api/games/updateBlasterBandana", {
      method: "POST",
            ...
            <div classname="PropertyLog">
              <div class="container">
                ...
                >
                  ...
                  <Form.Control
                    name="blasterID"
                    placeholder="Blaster ID"
                    value={this.state.blasterID}
                  />
                  <Form.Label>Bandana ID</Form.Label>
                  <Form.Control
                    name="bandanaID"
                    placeholder="Bandana ID"
                    value={this.state.bandanaID}
                  />
        ...
        return (
          <div class="container">
            ...
            <p class="font-weight-light">
              Blaster: {this.state.prevBlasterID} and Bandana:{" "}
              {this.state.prevBandanaID} logged to {this.state.prevResult}
            </p>
          </div>
        );
      }
