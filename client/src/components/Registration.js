...
class Registration extends React.Component {
  ...
  async componentDidMount() {
    ...
    fetch(
      ...
      .catch((err) =>
        console.log("An error Occured Loading the Game Name", err)
      );
  }
  ...
  handleSubmit(e) {
    e.preventDefault();
    // Call fetch function.
    fetch(process.env.REACT_APP_API_URL + "/api/account/registerUser", {
      method: "POST",
          ...
          <div class="container">
            <div class="row align-items-center mb-3">
              <h1 class="font-weight-light">
                Register for Game: {this.state.gameName}
              </h1>
            </div>
            ...
            <Form onSubmit={this.handleSubmit}>
              <Form.Group onChange={this.handleInputChange}>
                <label>
                  Do you want to be considered for the original horde?
                  <br />
                  <input
                    type="checkbox"
                    name="horde"
                ...
                <br />
                <label>
                  Do you want to recieve text and email notifications? <br />
                  <input
                    type="checkbox"
                    name="notify"
